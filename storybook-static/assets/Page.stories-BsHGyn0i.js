import{w as p,e as n,u as B}from"./Button-wHGSBfPF.js";import{P as d}from"./Page-CRdS0psh.js";import"./index-DZLKizrv.js";import"./jsx-runtime-Cw0GR0a5.js";import"./index-CTjT7uj6.js";import"./Header-Dm6VD-UL.js";const x={title:"Example/Page",component:d,parameters:{layout:"fullscreen"}},t={},o={play:async({canvasElement:g})=>{const a=p(g),e=a.getByRole("button",{name:/Log in/i});await n(e).toBeInTheDocument(),await B.click(e),await n(e).not.toBeInTheDocument();const l=a.getByRole("button",{name:/Log out/i});await n(l).toBeInTheDocument()}};var c,s,r;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:"{}",...(r=(s=t.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};var u,i,m;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
